...
# import numpy as gfg
#
# img_happy_csv = pd.read_csv("fer2013.csv")
#
#
# sample_faces_happy = []
# for pixel_sequence in img_happy_csv:
#     face = [pixel for pixel in pixel_sequence.split()]
#     face = np.asarray(face)
#
#     # face = face / 255.0
#     # sample_faces_happy.append(face.astype('float32'))
#
# sample_faces_happy = np.asarray(sample_faces_happy)
# sample_faces_happy = np.expand_dims(sample_faces_happy, -1)
#
# mymodel = load_model('/models/fer_model.h5')
#
# predictions_happy = mymodel.predict(sample_faces_happy, verbose=0)
